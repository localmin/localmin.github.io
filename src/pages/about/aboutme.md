...
* システムエンジニア/アプリケーションエンジニア@JTBC
    * NW装置のシステム開発
        * 最近はデータセンター向けのNW装置の仕様策定やドライバ開発をしてます
...
* 学歴
  * 2017/3 学士(工学)
  * 2019/3 修士(情報科学)
      * 亜種の[Nonnegative Matrix Factorization(NMF)](https://en.wikipedia.org/wiki/Non-negative_matrix_factorization)のアルゴリズムを研究をしていました
* Otaku(Moe-pig)
